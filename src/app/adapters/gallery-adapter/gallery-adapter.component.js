...
var GalleryAdapterComponent = (function () {
    function GalleryAdapterComponent() {
        this.imagesPaths = [];
        for (var i = 0; i < 17; i++) {
            this.imagesPaths.push("../../assets/images/gallery-image" + (i + 1) + ".jpg");
        }
    }
    GalleryAdapterComponent = __decorate([
        core_1.Component({
    ...
    return GalleryAdapterComponent;
}());
exports.GalleryAdapterComponent = GalleryAdapterComponent;
