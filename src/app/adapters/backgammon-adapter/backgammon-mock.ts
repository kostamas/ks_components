  ...
  public static db = {
    ...
    games: {
      game1: {
        isComplete: false,
        checkers: {
          1: {currentSpike: 4, isOffBoard: false},
          2: {currentSpike: 2 , isOffBoard: false},
