import {ICancellationFee, ICancellationPolicy, IOneContractParams} from '../../../../types/one-contract-object';
import {ICancellationPolicyParams, ISectionPageService} from '../../../../types/one-contract';
