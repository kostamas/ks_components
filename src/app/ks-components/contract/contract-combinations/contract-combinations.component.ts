...
import {
	ISvgIcons, SVG_ICONS, SelectInputService, OPTIONS_TYPES, JsUtils, InputUtils
...
import {IOneContractParams, ISupplementCombination} from '../../../../types/one-contract-object';
...
import {IContractCombinationsPrams, IContractSelectedDiscounts} from '../../../../types/one-contract';
