...
import {IPopulateService, IRoomsAndAvailability, ISectionPageService} from '../../../../types/one-contract';
import {INameId, IOneContractParams, IRoom} from '../../../../types/one-contract-object';
