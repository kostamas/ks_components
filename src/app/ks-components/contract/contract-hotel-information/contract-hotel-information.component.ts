...
import {ISelectItem, ISelectOptionsComponentsTypes} from 'shared-ui-components-lib/types/ISelect';
import {ContractHotelInformationService} from './contract-hotel-information.service';
import {
	JsUtils, SelectInputService, ModalService, ISvgIcons, SVG_ICONS, OPTIONS_TYPES, InputUtils
} from 'shared-ui-components-lib';
import {INameId, IOneContractParams} from '../../../../types/one-contract-object';
...
import {IModal} from 'shared-ui-components-lib/types/modal';
...
export class ContractHotelInformationComponent implements OnInit, OnDestroy {
	...
	openContractDetails(): void {
		this.modal = this.modalService.open(ContractDetailsModalComponent, {showCloseButton: true});
	}
