...
import {
	ISvgIcons, SVG_ICONS, DATE_FORMAT, JsUtils, SelectInputService
} from 'shared-ui-components-lib';
import {IRadioButton} from 'shared-ui-components-lib/types/buttons';
import {IContractSeason, IRatesParams} from '../../../../types/one-contract';
...
import {IOneContractParams, IRate, ISeason} from '../../../../types/one-contract-object';
